            ...
            getUser().then((user) => {
              findMember(user).then((user) => {
                let welcomeMsg = new Promise(function(resolve, reject) {
                  sendTextMessage(event.sender.id, user.pageAccessToken, 'Thanks for messaging Affirmation.Today! Walk through this demo to get a feel for how Irrigate can help your business do e-commerce within Messenger.')
                  resolve()
                })
